...
//    
//    // MARK: - POST Request
//    func postRequest(urlString: String, body: [String: Any], completion: @escaping (Result<Data, Error>) -> Void) {
//        guard let url = URL(string: urlString) else {
//            completion(.failure(NSError(domain: "Invalid URL", code: -1)))
//            return
//        }
...
//    
//    // MARK: - PUT Request
//    func putRequest(urlString: String, body: [String: Any], completion: @escaping (Result<Data, Error>) -> Void) {
//        guard let url = URL(string: urlString) else {
//            completion(.failure(NSError(domain: "Invalid URL", code: -1)))
//            return
//        }
